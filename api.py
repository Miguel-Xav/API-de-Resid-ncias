    ...
    while True:
        ...
        if escolha == '1':
            ...
            if nome_cad is None:
                ...
                if endereco_cad is None:
                        ...
                        if cep_cad is None:
                            ...
                            id_nova_res = adicionar_res(nome_cad, endereco_cad, cep_cad)
            ...
            if id_res.lower() == 'sair':
                ...
                time.sleep (2)
                continue
            dados_res = listar_res()
            residencia = next((r for r in dados_res if r[0] == int(id_res)), None)

            if residencia:
                novo_nome = obt_nome_res() or residencia[1]
                novo_endereco = obt_end_res() or residencia[2]
                novo_cep = obt_cep_res() or residencia[3]

                edit_res(residencia[0], novo_nome, novo_endereco, novo_cep)
